...
const Testimonial = () => {
  const testimonialData = [
    ...
    },
    {
      ...
      title: "Divya K C",
      description:
        "We recently bought five main entrance doors and two bedroom doors from i-Leaf, and we're thoroughly impressed with their quality, secure locking system, and fine finish. These doors have truly enhanced the overall look of our home, giving it a premium feel. We're very happy with our purchase and would highly recommend i-Leaf to anyone looking for stylish and reliable doors for their home.",
      image: divya_kc,
    },
    {
      id: "3",
    ...
    },
    {
      ...
      description:
        "We have been using i-Leaf Steel Doors for the past three years and have installed a total of 34 doors, including at my brother's house and my own. We haven't encountered a single issue with any of them. We're extremely satisfied with the quality and performance of these doors.",
    ...
    },
    {
      ...
      description:
        "We chose i-Leaf steel doors for our property, and it turned out to be an excellent decision. During an attempted burglary at our home, the i-Leaf door demonstrated its superior quality and robust security features, effectively preventing any breach. We were truly impressed—not only by the product but also by the prompt support from their team, who replaced the door within a day. We're sincerely grateful to the i-Leaf team for their quick response and unwavering support during a difficult time",
      image: remya,
    },
  ];
            ...
            <div className="relative flex flex-col justify-center items-center ">
              <div className="relative w-full lg:max-w-[70%] ">
                <div className="relative">
                  <div className="text-[#707070] text-center font-style leading-[160%] !tracking-[0.5px] w-full">
                    <p className={expandedId === item.id ? "" : "line-clamp-[7]"}>
                      {item.description}
                    </p>
                    {expandedId !== item.id && (
                      <div className="flex justify-center items-center mt-1">
                        ...
                        <button
                          ...
                          className="bg-amber-400 rounded-full p-0.5"
