      ...
      <div className="bg-cover bg-center bg-no-repeat flex justify-center items-center">
        <div className="w-full h-full flex items-center justify-center">
          <p className="text-black font-[300] italic text-base leading-7 tracking-[1px] text-center font-raleway md:max-w-[64%]">
            ...
            hectic work schedules and constant travel.<span className="max-sm:inline-block">This has led to a growing
            ...
            is designed to meet your every need.<span className="inline-block">From security steel doors and
            steel windows for living rooms, kitchens, and bathrooms, we ensure
            the perfect solution for every space.</span></span>
          </p>
        </div>
      </div>
      <Parallelogram />
