  ...
  return (
    <div className="w-full min-h-screen flex  flex-col md:flex-row bg-[#dbdbdb] justify-evenly py-20 px-6 inset-0">
      <div className="text-center md:w-1/3 ">
        <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-blafhyglibs tracking-[4px] lg:tracking-[7px] italic leading-[120%]">
          {heading1}
        </h1>
        <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-blafhyglibs tracking-[4px] lg:tracking-[7px] italic leading-[120%]">
          {heading2}
      ...
      <div className="flex-1 flex flex-col gap-10 justify-center items-center md:w-1/3 ">
        <p className="text-center text-sm md:text-base italic text-black max-w-sm font-raleway">
          {description}
        </p>
        <button className="uppercase p-3 px-6 lg:p-4 lg:px-8 transform -skew-x-12 text-sm lg:text-base bg-amber-400 font-raleway font-bold">
          Explore now
        </button>
      </div>
