  ...
  return (
    <div className="min-h-screen relative top-0 left-0 w-full">
      <div className="relative h-screen w-full">
        ...
        <button
          onClick={toggleMenu}
          className="text-yellow-400 fixed lg:hidden focus:outline-none  top-4 right-4 z-[60]"
        ...
        >
          ...
          <div className='flex-1 flex flex-col gap-10 justify-center items-center'>
            <button className='uppercase p-3 px-6 lg:p-4 lg:px-8 transform -skew-x-12 text-sm lg:text-base border border-[#707070] text-amber-400'>download brochure</button>
        </div>
        </div>

        <div className="relative z-10 h-full flex flex-col justify-center items-center">
          <div className="flex-1 flex items-start md:items-center justify-end px-6 md:px-8 lg:px-12 w-[80%] py-10">
            <div className="max-w-2xl md:text-right text-center uppercase">
              <h1 className="text-2xl md:text-3xl italic  text-yellow-400 lg:text-white leading-tight mb-2 lg:mb-4 ">
                <span className="block mb-2 lg:mb-4 md:mr-16 font-blafhyglibs tracking-[4px] lg:tracking-[7px]">
                  The Door to
                </span>
                <span className="block italic md:mr-12 font-blafhyglibs tracking-[4px] lg:tracking-[7px]">Unmatched</span>
              </h1>

              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl italic text-amber-400 leading-tight">
                <span className="inline-block md:mr-6 font-blafhyglibs tracking-[4px] lg:tracking-[7px]">Safety and Security</span>
