...
async function DoorDetailsPage({ params }: { params: Params }) {
  ...
  const allProducts = windowsData["Windows"].series[0].variants;

  return (
    <>
      <ProductHero bgImage="https://res.cloudinary.com/db4zbyipc/image/upload/v1751663555/window-hero_wuhjmx.webp" />
